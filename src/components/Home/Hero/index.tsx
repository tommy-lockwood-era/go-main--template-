            ...
            <form className="mx-4 flex w-full flex-col gap-3 rounded-3xl bg-white p-8">
              ...
              <div>
                <input
                  ...
                  name="isSameDropoff"
                  id="isSameDropoff"
                  onChange={() => toggleHideDropOffLocation((prev) => !prev)}
                  checked={hideDropOffLocation}
                />
                <label htmlFor="isSameDropoff" className="text-black">
              ...
              <div className="grid grid-cols-2 rounded-sm border border-gray-500">
                ...
                <div className="text-rgreen-400 py-5">Pickup Details</div>
              </div>

              {/* Pickup & Drop-Off Details Modal */}
              <div className="fixed left-36 flex flex-col items-end rounded-sm bg-gray-200 p-6 shadow-lg">
                <button type="button" className="size-8 rounded-full bg-black">
                  &#10006;
                </button>
              ...
              <div className="flex justify-between">
                <div>
                  Discount: <button type="button">+ Add</button>
                </div>
                <div>
                  Driver's age: <button type="button">25+</button>
                </div>
              </div>
              <button
                type="submit"
            ...
            <div className="mx-auto mb-12 max-w-[720px] text-center lg:mb-0 lg:ml-0 lg:text-left">
              ...
              <div className="flex flex-col gap-4 lg:flex-row">
                <div className="flex gap-2">
                  ...
                  <div>
                    <p className="font-bold">#1 Loyalty Program</p>
                ...
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <p>With 10k+ rental locations worldwide</p>
                  </div>
                </div>
              </div>
            </div>
